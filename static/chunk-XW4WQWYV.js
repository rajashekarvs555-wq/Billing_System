import{a as tt}from"./chunk-B5GEYZPP.js";import{a as X}from"./chunk-ZDVINK2N.js";import{a as Y}from"./chunk-TKOON2AY.js";import{a as R,b as v,c as j,d as D,f as G,g as z,h as q,i as L,j as U,k as W,l as Q,m as Z,n as H,o as J,q as K}from"./chunk-77FSFZ7B.js";import{a as $}from"./chunk-JQ65RHU4.js";import{$a as o,Cb as k,Da as O,Db as I,Gb as V,Ha as x,Hb as A,Oa as p,Ra as i,Sa as e,Ta as m,Ua as E,Va as b,Wa as y,Z as F,_ as M,ab as T,bb as S,hb as C,jb as w,ua as s,ya as N}from"./chunk-EQL4FING.js";function it(d,l){d&1&&(i(0,"div",74),o(1," Bill Number is required. "),e())}function nt(d,l){d&1&&(i(0,"div",74),o(1," Date is required. "),e())}function lt(d,l){if(d&1&&(i(0,"option",75),o(1),e()),d&2){let t=l.$implicit;p("value",t.id),s(),S(" ",t.customer_name," ")}}function ot(d,l){d&1&&(i(0,"div",74),o(1," Customer selection is required. "),e())}function rt(d,l){if(d&1){let t=E();i(0,"tr",76)(1,"td",77),m(2,"input",78),e(),i(3,"td",79),m(4,"input",80),e(),i(5,"td",81),m(6,"input",82),e(),i(7,"td",83),m(8,"input",84),e(),i(9,"td",85)(10,"input",86),b("input",function(){let r=F(t).index,c=y();return M(c.calculateRow(r))}),e()(),i(11,"td",87)(12,"input",88),b("input",function(){let r=F(t).index,c=y();return M(c.calculateRow(r))}),e()(),i(13,"td",89),m(14,"input",90),e(),i(15,"td",91)(16,"button",92),b("click",function(){let r=F(t).index,c=y();return M(c.removeItemRow(r))}),m(17,"i",93),e()()()}if(d&2){let t=l.index,n=y();p("formGroupName",t),s(16),p("disabled",n.items.length<=1)}}function at(d,l){if(d&1&&(i(0,"div",94),o(1),e()),d&2){let t=y();s(),S(" ",t.items.length," line item(s) included ")}}function st(d,l){if(d&1){let t=E();i(0,"div",95)(1,"div",96)(2,"div",97)(3,"h3"),m(4,"i",98),i(5,"span",99),o(6,"Seller Company Settings"),e()(),i(7,"button",100),b("click",function(){F(t);let r=y();return M(r.closeSellerModal())}),m(8,"i",101),e()(),i(9,"form",102),b("ngSubmit",function(){F(t);let r=y();return M(r.submitSellerProfile())}),i(10,"div",103)(11,"label",13),o(12,"Company / Seller Name *"),e(),m(13,"input",104),e(),i(14,"div",103)(15,"label",13),o(16,"Company Address *"),e(),m(17,"textarea",105),e(),i(18,"div",20)(19,"label",13),o(20,"GSTIN *"),e(),m(21,"input",106),e(),i(22,"div",20)(23,"label",13),o(24,"Cell / Contact Phone *"),e(),m(25,"input",107),e(),i(26,"div",108)(27,"button",69),b("click",function(){F(t);let r=y();return M(r.closeSellerModal())}),o(28,"Cancel"),e(),i(29,"button",109),o(30,"Save Business Profile"),e()()()()()}if(d&2){let t=y();s(9),p("formGroup",t.sellerForm)}}function mt(d,l){if(d&1&&m(0,"option",75),d&2){let t=l.$implicit;p("value",t.vehicle_no)}}function dt(d,l){if(d&1&&m(0,"option",75),d&2){let t=l.$implicit;p("value",t.material_name)}}var et=class d{constructor(l,t,n,r,c){this.fb=l;this.customerService=t;this.billService=n;this.toast=r;this.inventoryService=c}fb;customerService;billService;toast;inventoryService;customers=[];vehicles=[];materials=[];billForm;sellerForm;loadedBillNo;showSellerModal=!1;ngOnInit(){this.initializeForm(),this.loadCustomers(),this.loadVehicles(),this.loadMaterials(),this.addItemRow(),this.fetchNextBillNo()}initializeForm(){this.billForm=this.fb.group({bill_no:["",[v.required,v.min(1)]],bill_date:[new Date().toISOString().split("T")[0],v.required],customer_id:["",v.required],gst_type:["none"],cgst_pct:[0],sgst_pct:[0],igst_pct:[0],cgst:[0],sgst:[0],igst:[0],notes:[""],items:this.fb.array([])});let l=this.getSellerProfile();this.sellerForm=this.fb.group({name:[l.name,v.required],address:[l.address,v.required],gstin:[l.gstin,v.required],phone:[l.phone,v.required]}),this.billForm.get("gst_type")?.valueChanges.subscribe(t=>{t==="none"?this.billForm.patchValue({cgst_pct:0,sgst_pct:0,igst_pct:0,cgst:0,sgst:0,igst:0},{emitEvent:!1}):this.calculateTotals()})}get items(){return this.billForm.get("items")}createItemRow(){return this.fb.group({item_date:[new Date().toISOString().split("T")[0]],vehicle:[""],material:[""],dc_no:[""],qty:[0,[v.min(0)]],rate:[0,[v.min(0)]],amount:[0]})}addItemRow(){this.items.push(this.createItemRow())}removeItemRow(l){this.items.removeAt(l),this.calculateTotals()}loadCustomers(){this.customerService.getCustomers().subscribe(l=>{this.customers=l})}loadVehicles(){this.inventoryService.getVehicles().subscribe(l=>this.vehicles=l,l=>console.error("Failed to load vehicles",l))}loadMaterials(){this.inventoryService.getMaterials().subscribe(l=>this.materials=l,l=>console.error("Failed to load materials",l))}calculateRow(l){let t=this.items.at(l),n=Number(t.get("qty")?.value||0),r=Number(t.get("rate")?.value||0);t.patchValue({amount:Math.round(n*r*100)/100},{emitEvent:!1}),this.calculateTotals()}get subtotal(){let l=0;return this.items.controls.forEach(t=>{l+=Number(t.get("amount")?.value||0)}),l}get taxAmount(){return Number(this.billForm.value.cgst||0)+Number(this.billForm.value.sgst||0)+Number(this.billForm.value.igst||0)}get grandTotal(){return this.subtotal+this.taxAmount}calculateTotals(){let l=this.subtotal,t=this.billForm.get("gst_type")?.value||"none";if(t==="cgst_sgst"){let n=Math.round(l*.09*100)/100;this.billForm.patchValue({cgst_pct:9,sgst_pct:9,igst_pct:0,cgst:n,sgst:n,igst:0},{emitEvent:!1})}else if(t==="igst"){let n=Math.round(l*.18*100)/100;this.billForm.patchValue({cgst_pct:0,sgst_pct:0,igst_pct:18,cgst:0,sgst:0,igst:n},{emitEvent:!1})}else if(t==="none"){let n=Number(this.billForm.get("cgst_pct")?.value||0),r=Number(this.billForm.get("sgst_pct")?.value||0),c=Number(this.billForm.get("igst_pct")?.value||0),f=Math.round(l*(n/100)*100)/100,h=Math.round(l*(r/100)*100)/100,g=Math.round(l*(c/100)*100)/100;this.billForm.patchValue({cgst:f,sgst:h,igst:g},{emitEvent:!1})}}getSellerProfile(){let l={name:"SARAVANA ENTERPRISES",address:"No 68, Kodoor Panchayat, Vellodai Road, Krishnapuram, Ponneri, Tamil Nadu, 601204",gstin:"33BBMPS6356P1ZR",phone:"9884878988"};if(typeof window>"u"||typeof localStorage>"u")return l;let t=localStorage.getItem("seller_profile");return t?JSON.parse(t):l}openSellerModal(){let l=this.getSellerProfile();this.sellerForm.patchValue(l),this.showSellerModal=!0}closeSellerModal(){this.showSellerModal=!1}submitSellerProfile(){if(this.sellerForm.invalid){this.sellerForm.markAllAsTouched();return}typeof localStorage<"u"&&localStorage.setItem("seller_profile",JSON.stringify(this.sellerForm.value)),this.showSellerModal=!1,this.toast.success("Seller profile updated successfully.")}saveBill(){if(this.billForm.invalid){this.billForm.markAllAsTouched(),this.toast.warning("Please fill in all required bill details.");return}let l=this.billForm.value;if(this.loadedBillNo){this.billService.updateBill(this.loadedBillNo,l).subscribe(t=>{this.toast.success("Bill updated successfully!"),this.loadedBillNo=t.bill_no},t=>{let n=t.error?.detail||"Failed to update bill.";this.toast.error(n)});return}this.billService.createBill(l).subscribe(t=>{this.loadedBillNo=t.bill_no,this.billForm.patchValue({bill_no:t.bill_no}),this.toast.success("Bill created successfully!")},t=>{let n=t.error?.detail||"Failed to create bill.";this.toast.error(n)})}loadBill(){let l=Number(this.billForm.value.bill_no);if(!l){this.toast.warning("Please enter a valid Bill Number to load.");return}this.billService.getBill(l).subscribe(t=>{this.loadedBillNo=t.bill_no,this.items.clear(),t.items.forEach(g=>{this.items.push(this.fb.group(g))});let n=t.gst_type;n==null&&(t.igst&&t.igst>0?n="igst":t.cgst&&t.cgst>0||t.sgst&&t.sgst>0?n="cgst_sgst":n="none");let r=t.subtotal||1,c=t.cgst_pct!==void 0&&t.cgst_pct!==null?t.cgst_pct:t.cgst?Math.round(t.cgst/r*1e4)/100:0,f=t.sgst_pct!==void 0&&t.sgst_pct!==null?t.sgst_pct:t.sgst?Math.round(t.sgst/r*1e4)/100:0,h=t.igst_pct!==void 0&&t.igst_pct!==null?t.igst_pct:t.igst?Math.round(t.igst/r*1e4)/100:0;this.billForm.patchValue({bill_no:t.bill_no,bill_date:t.bill_date,customer_id:t.customer_id||t.customer?.id,gst_type:n,cgst_pct:c,sgst_pct:f,igst_pct:h,cgst:t.cgst||0,sgst:t.sgst||0,igst:t.igst||0,notes:t.notes||""},{emitEvent:!1}),this.toast.success(`Bill #${l} loaded successfully.`)},t=>{this.toast.error(`Bill #${l} not found.`)})}downloadExcel(){this.loadedBillNo&&this.billService.downloadExcel(this.loadedBillNo).subscribe(l=>{let t=window.URL.createObjectURL(l),n=document.createElement("a");n.href=t;let r=l.type.includes("csv");n.download=`Bill_${this.loadedBillNo}${r?".csv":".xlsx"}`,n.click(),window.URL.revokeObjectURL(t)})}downloadPdf(){if(!this.loadedBillNo){this.toast.warning("Please save the bill first before downloading PDF.");return}let l=this.customers.find(a=>a.id===Number(this.billForm.value.customer_id)),t=l?l.customer_name:"Unknown Customer",n=l&&l.address||"&mdash;",r=l&&l.gst_number||"&mdash;",c=this.getSellerProfile(),f=this.billForm.value.items||[],h=a=>Number(a||0).toLocaleString("en-IN",{minimumFractionDigits:2,maximumFractionDigits:2}),g=a=>"\u20B9 "+h(a),u=window.open("","_blank");if(!u){this.toast.error("Popup blocker is active. Please allow popups to download PDF.");return}u.document.write(`
      <html>
      <head>
      ...
      <body>
          ...
          <tbody>
            ${f.map((a,_)=>`
              <tr>
                ...
                <td>${a.material||""}</td>
                <td>${a.dc_no||""}</td>
                <td class="text-right">${a.qty||0}</td>
                <td class="text-right">${h(a.rate)}</td>
                <td class="text-right">${g(a.amount)}</td>
              </tr>
            `).join("")}
            
            <!-- Generate blank rows to fill visual grid up to 12 rows exactly like spreadsheet -->
            ${Array(Math.max(0,12-f.length)).fill(0).map((a,_)=>`
              <tr>
        ...
        <div class="footer-section">
          ...
          <table class="totals-table">
            <tr>
              <td>Sub Total</td>
              <td class="text-right">${h(this.subtotal)}</td>
            </tr>
            ${this.billForm.value.cgst>0?`
              <tr>
                <td>CGST</td>
                <td class="text-right">${h(this.billForm.value.cgst)}</td>
              </tr>
            `:""}
            ${this.billForm.value.sgst>0?`
              <tr>
                <td>SGST</td>
                <td class="text-right">${h(this.billForm.value.sgst)}</td>
              </tr>
            `:""}
            ${this.billForm.value.igst>0?`
              <tr>
                <td>IGST</td>
                <td class="text-right">${h(this.billForm.value.igst)}</td>
              </tr>
            `:""}
